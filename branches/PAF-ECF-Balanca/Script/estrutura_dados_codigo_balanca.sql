...
MySQL - 5.1.48-community : Database - t2tipafecf
*********************************************************************
*/
...
DROP TABLE IF EXISTS `nf2_cabecalho`;
...
DROP TABLE IF EXISTS `nf2_detalhe`;
...
CREATE TABLE `produto` (
  ...
  `CODIGO_BALANCA` int(4) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
DROP TABLE IF EXISTS `situacao_cli`;
